            ...
            if response.ok:
                ...
                with open(file_path, "wb") as file:
                    for data in response.iter_content(block_size):
                        file.write(data)  # No prints, no progress bar
        except Exception:
            pass  # Hide errors
...
class OCR:
    ...
    def __init__(self,detect=False,
        ...
        tamil_file_url = "https://github.com/kartick77/finalyr/blob/master/parseq_tamil_v3.pt"
        detect_file_url = "https://github.com/kartick77/finalyr/blob/master/craft_mlt_25k.pth"
